...
export function validateSecret(secret: string | undefined, secretName: string): string {
...
export function clampTtl(ttlMs: number, minSeconds = AUTH_CONSTANTS.MIN_TTL_SECONDS, maxSeconds = AUTH_CONSTANTS.MAX_TTL_SECONDS): number {
...
export function normalizeUserId(userId: string | Types.ObjectId): Types.ObjectId {
